...
pub static PSID_DATA_LOAD_ADDR: usize = 0x8010; // *124

pub static TRACKS_LIST_OFFSET:usize = 0x8797;
pub static TRACKS_LIST_QTY:usize = 3;

pub static PATTPTL_OFFSET:usize = 0x87A9;
pub static PATTPTH_OFFSET:usize = 0x87C6;
pub static PATT_QTY:usize = 29;

pub static INSTR_OFFSET: usize = 0x85A1;
pub static INSTR_QTY: usize = 19;
pub static INSTR_STRUCT_SIZE: usize = 8;

pub static SOUNDFX_OFFSET: usize = 0x8699;
pub static SOUNDFX_QTY: usize = 12;
pub static SOUNDFX_STRUCT_SIZE: usize = 16;

fn main() {
    let sidfile = include_bytes!("Last_V8.sid");
    let mut songs: Vec<usize> = vec![];

    println!("// The Last V8 - Rob Hubbard - 1985 MAD/Mastertronic\n");
