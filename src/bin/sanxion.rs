...
pub static TRACKS_LIST_OFFSET:usize = 0xB73C;
pub static TRACKS_LIST_QTY:usize = 1;

pub static PATTPTL_OFFSET:usize = 0xB742;
pub static PATTPTH_OFFSET:usize = 0xB75D;
pub static PATT_QTY:usize = 27;

pub static INSTR_OFFSET: usize = 0xB56C;
pub static INSTR_QTY: usize = 29;
pub static INSTR_STRUCT_SIZE: usize = 8;

pub static INSTRFX_OFFSET: usize = 0xB654;
pub static INSTRFX_QTY: usize = 29;
...
fn main() {
    ...
    println!("// Sanxion - Rob Hubbard - 1986 Thalamus\n");
