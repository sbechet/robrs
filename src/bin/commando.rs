...
pub static TRACKS_LIST_OFFSET:usize = 0x56FF;
pub static TRACKS_LIST_QTY:usize = 3;

pub static PATTPTL_OFFSET:usize = 0x5711;
pub static PATTPTH_OFFSET:usize = 0x573E;
pub static PATT_QTY:usize = 45;

pub static INSTR_OFFSET: usize = 0x5591;
pub static INSTR_QTY: usize = 13;
pub static INSTR_STRUCT_SIZE: usize = 8;

pub static SOUNDFX_OFFSET: usize = 0x55F9;
pub static SOUNDFX_QTY: usize = 16;
pub static SOUNDFX_STRUCT_SIZE: usize = 16;

fn main() {
    let sidfile = include_bytes!("Commando.sid");
