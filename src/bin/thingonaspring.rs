...
pub static PSID_DATA_LOAD_ADDR: usize = 0xC000;

pub static TRACKS_LIST_OFFSET:usize = 0xC509;
pub static TRACKS_LIST_QTY:usize = 1;

pub static PATTPTL_OFFSET:usize = 0xC50F;
pub static PATTPTH_OFFSET:usize = 0xC533;
pub static PATT_QTY:usize = 36;

pub static INSTR_OFFSET: usize = 0xCD2A;
pub static INSTR_QTY: usize = 45;
pub static INSTR_STRUCT_SIZE: usize = 8;

pub static SOUNDFX_OFFSET: usize = 0xCE92;
pub static SOUNDFX_QTY: usize = 1;
pub static SOUNDFX_STRUCT_SIZE: usize = 16;

fn main() {
    let sidfile = include_bytes!("Thing_on_a_Spring.sid");
    let mut songs: Vec<usize> = vec![];

    println!("// Thing on a Spring - Rob Hubbard - 1985 Gremlin Graphics\n");
