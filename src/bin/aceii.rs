// _NOT_ working! this is a just a try but code is slighty different.

use std::collections::HashMap;

pub static PSID_HEADER_SIZE: usize = 126;

pub static PSID_DATA_LOAD_ADDR: usize = 0xE000;

pub static TRACKS_LIST_OFFSET:usize = 0xE67C;
pub static TRACKS_LIST_QTY:usize = 1;

pub static PATTPTL_OFFSET:usize = 0xE682;
pub static PATTPTH_OFFSET:usize = 0xE6A8;
pub static PATT_QTY:usize = 38;

pub static INSTR_OFFSET: usize = 0xE5CB;
pub static INSTR_QTY: usize = 10;
pub static INSTR_STRUCT_SIZE: usize = 8;

pub static SOUNDFX_OFFSET: usize = PSID_DATA_LOAD_ADDR;
pub static SOUNDFX_QTY: usize = 0;
pub static SOUNDFX_STRUCT_SIZE: usize = 16;

fn main() {
    let sidfile = include_bytes!("ACE_II.sid");
    let mut songs: Vec<usize> = vec![];

    println!("// ACE II - Rob Hubbard - 1987 Arcade\n");
