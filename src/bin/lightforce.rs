...
pub static PSID_DATA_LOAD_ADDR: usize = 0xF000;

pub static TRACKS_LIST_OFFSET:usize = 0xF778;
pub static TRACKS_LIST_QTY:usize = 1;

pub static PATTPTL_OFFSET:usize = 0xF77E;
pub static PATTPTH_OFFSET:usize = 0xF79D;
pub static PATT_QTY:usize = 31;

pub static INSTR_OFFSET: usize = 0xF618;
pub static INSTR_QTY: usize = 22;
pub static INSTR_STRUCT_SIZE: usize = 8;

pub static INSTRFX_OFFSET: usize = 0xF6C8;
pub static INSTRFX_QTY: usize = 22;
pub static INSTRFX_STRUCT_SIZE: usize = 8;

fn main() {
    let sidfile = include_bytes!("Lightforce.sid");
    let mut songs: Vec<usize> = vec![];

    println!("// Lightforce - Rob Hubbard - 1986 Faster Than Light (FTL)\n");
