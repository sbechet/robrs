...
pub static PSID_DATA_LOAD_ADDR: usize = 0x5000;

pub static TRACKS_LIST_OFFSET:usize = 0x5732;
pub static TRACKS_LIST_QTY:usize = 2;

pub static PATTPTL_OFFSET:usize = 0x573E;
pub static PATTPTH_OFFSET:usize = 0x5773;
pub static PATT_QTY:usize = 53;

pub static INSTR_OFFSET: usize = 0x5574;
pub static INSTR_QTY: usize = 23;
pub static INSTR_STRUCT_SIZE: usize = 8;

pub static SOUNDFX_OFFSET: usize = 0x562C;
pub static SOUNDFX_QTY: usize = 1;
pub static SOUNDFX_STRUCT_SIZE: usize = 16;

fn main() {
    let sidfile = include_bytes!("Crazy_Comets.sid");
    let mut songs: Vec<usize> = vec![];

    println!("// Crazy Comets - Rob Hubbard - 1985 Martech\n");
