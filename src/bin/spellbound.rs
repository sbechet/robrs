// WARN: second byte & 0b1000_0000 -> note. No vibrato. -- check soundfx too
...
pub static TRACKS_LIST_OFFSET:usize = 0xE6B6;
pub static TRACKS_LIST_QTY:usize = 3;

pub static PATTPTL_OFFSET:usize = 0xE6C8;
pub static PATTPTH_OFFSET:usize = 0xE6F2;
pub static PATT_QTY:usize = 42;

pub static INSTR_OFFSET: usize = 0xE548;
pub static INSTR_QTY: usize = 25;
pub static INSTR_STRUCT_SIZE: usize = 8;

pub static SOUNDFX_OFFSET: usize = 0xE610;
pub static SOUNDFX_QTY: usize = 16;
pub static SOUNDFX_STRUCT_SIZE: usize = 16;

fn main() {
    let sidfile = include_bytes!("Spellbound.sid");
    let mut songs: Vec<usize> = vec![];

    println!("// Spellbound - Rob Hubbard - 1986 MAD/Mastertronic\n");
...
pub static RHSONGS: RhSongs = RhSongs {{
    musicplayer: MusicPlayer::SpellBound,
    total: TOTAL_SONGS,
    tracks: &TRACKS,
    patterns: &PATTERNS,
