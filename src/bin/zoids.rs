...
pub static PSID_DATA_LOAD_ADDR: usize = 0x1000; // *124

pub static TRACKS_LIST_OFFSET:usize = 0x14FC;
pub static TRACKS_LIST_QTY:usize = 3;

pub static PATTPTL_OFFSET:usize = 0x150E;
pub static PATTPTH_OFFSET:usize = 0x152D;
pub static PATT_QTY:usize = 31;

pub static INSTR_OFFSET: usize = 0x147E;
pub static INSTR_QTY: usize = 15;
pub static INSTR_STRUCT_SIZE: usize = 8;

fn main() {
    let sidfile = include_bytes!("Zoids.sid");
...
pub static RHSONGS: RhSongs = RhSongs {{
    ...
    // ********* SOUNDFX
    println!("\n\n#[allow(dead_code)]");
    println!("pub static SOUNDFX: [ SoundFx; 0] = [];");
