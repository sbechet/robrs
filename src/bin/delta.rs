...
pub static PSID_DATA_LOAD_ADDR: usize = 0xBC00;

pub static TRACKS_LIST_OFFSET:usize = 0xC4F4;
pub static TRACKS_LIST_QTY:usize = 13;

pub static PATTPTL_OFFSET:usize = 0xC542;
pub static PATTPTH_OFFSET:usize = 0xC5AF;
pub static PATT_QTY:usize = 109;

pub static INSTR_OFFSET: usize = 0xC38E;
pub static INSTR_QTY: usize = 22;
pub static INSTR_STRUCT_SIZE: usize = 8;

pub static INSTRFX_OFFSET: usize = 0xC43E;
pub static INSTRFX_QTY: usize = 22;
pub static INSTRFX_STRUCT_SIZE: usize = 8;

fn main() {
    let sidfile = include_bytes!("Delta.sid");
    let mut songs: Vec<usize> = vec![];

    println!("// Delta - Rob Hubbard - 1987 Thalamus\n");
