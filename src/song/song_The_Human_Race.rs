...
#[allow(dead_code)]
pub static CHANNEL_EMPTY: [u8; 1] = [255];

#[allow(dead_code)]
pub static CHANNELS: [&[&[u8]; 3]; 5] = [
    &[&CHANNEL_0, &CHANNEL_1, &CHANNEL_EMPTY],
    &[&CHANNEL_2, &CHANNEL_3, &CHANNEL_EMPTY],
    &[&CHANNEL_4, &CHANNEL_5, &CHANNEL_EMPTY],
    &[&CHANNEL_6, &CHANNEL_7, &CHANNEL_EMPTY],
    &[&CHANNEL_8, &CHANNEL_9, &CHANNEL_EMPTY],
];

#[allow(dead_code)]
pub static TRACKS: [&[u8]; 79] = [
    ...
    &TRACK_73, &TRACK_74, &TRACK_75, &TRACK_76, &TRACK_77, &TRACK_78,
];
#[allow(dead_code)]
...
#[allow(dead_code)]
pub static TRACK_19: [u8; 10] = [0x81, 0x6, 0x2E, 0x1, 0x2E, 0x3, 0x2E, 0x3, 0x2C, 0xFF];
#[allow(dead_code)]
pub static TRACK_20: [u8; 20] = [
